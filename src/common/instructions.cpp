...
static const std::unordered_set<std::string> valid_instructions = {
    ...
    "SIMDF_add32","SIMDF_sub32","SIMDF_mul32","SIMDF_div32","SIMDF_rem32","SIMDF_ld32","injectFlip", "checkError",// newly added instructions 
...
static const std::unordered_set<std::string> RTypeInstructions = {
    ...
    // RV64
    "addw", "subw", "sllw", "srlw", "sraw","SIMD_add32","SIMD_sub32","SIMD_mul32","SIMD_load32","SIMD_div32","SIMD_rem32","SIMD_add16","SIMD_sub16","SIMD_mul16","SIMD_div16","SIMD_rem16","SIMD_load16_upper","SIMD_load16_lower", "injectFlip","checkError",
