...
std::unordered_map<std::string, Instruction> instruction_string_map = {
    ...
    {"setSig",Instruction::ksetSig},
    {"checkError",Instruction::kcheckError},
...
static const std::unordered_set<std::string> valid_instructions = {
    ...
    "SIMDF_add32","SIMDF_sub32","SIMDF_mul32","SIMDF_div32","SIMDF_rem32","SIMDF_ld32","injectFlip", "checkError","setSig",// newly added instructions 
...
static const std::unordered_set<std::string> RTypeInstructions = {
    ...
    // RV64
    "addw", "subw", "sllw", "srlw", "sraw","SIMD_add32","SIMD_sub32","SIMD_mul32","SIMD_load32","SIMD_div32","SIMD_rem32","SIMD_add16","SIMD_sub16","SIMD_mul16","SIMD_div16","SIMD_rem16","SIMD_load16_upper","SIMD_load16_lower", "injectFlip","checkError","setSig",
...
std::unordered_map<std::string, RTypeInstructionEncoding> R_type_instruction_encoding_map = {
    ...
    {"checkError", {0b0110011, 0b001, 0b0011111}},
    {"setSig", {0b0110011, 0b010, 0b0011111}},
...
std::unordered_map<std::string, std::vector<SyntaxType>> instruction_syntax_map = {
    ...
    {"checkError", {SyntaxType::O_GPR_C_GPR_C_GPR}},
    {"setSig", {SyntaxType::O_GPR_C_GPR_C_GPR}},
